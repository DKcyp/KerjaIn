-- Migration: Add sumber (BAFrom) and submitted_at to bacara table
...
-- 5. Backfill: records already in PENGAJUAN or beyond get submitted_at = updatedAt as best estimate
UPDATE bacara
